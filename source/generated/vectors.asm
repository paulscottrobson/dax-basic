...
VectorsSet0:
	...
	addr(Unimplemented)              ; $0096 $
	addr(Unimplemented)              ; $0097 rnd
	addr(Unary_Len)                  ; $0098 len
	addr(Unary_Abs)                  ; $0099 abs
	addr(Unary_Sgn)                  ; $009a sgn
	addr(Unimplemented)              ; $009b int
	addr(Unimplemented)              ; $009c str
	addr(Unimplemented)              ; $009d chr
	addr(Unary_Asc)                  ; $009e asc
	addr(Unary_Not)                  ; $009f not
	addr(Unary_Page)                 ; $00a0 page
	addr(Unimplemented)              ; $00a1 string
	addr(Unimplemented)              ; $00a2 time
	addr(Unary_Top)                  ; $00a3 top
	addr(Unary_Val)                  ; $00a4 val
	...
	addr(Unimplemented)              ; $00b9 let
	addr(Unimplemented)              ; $00ba vdu
	addr(Unimplemented)              ; $00bb print
